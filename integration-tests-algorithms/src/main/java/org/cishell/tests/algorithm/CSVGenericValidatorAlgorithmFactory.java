...
public class CSVGenericValidatorAlgorithmFactory implements AlgorithmFactory {

    public Algorithm createAlgorithm(Data[] data, Dictionary parameters, CIShellContext context) {
        return new CSVGenericValidatorAlgorithm(data, parameters, context);
    }

    private class CSVGenericValidatorAlgorithm implements Algorithm {

        private String filepath = null;
        private Dictionary<String, Object> metadata = null;

        private CSVGenericValidatorAlgorithm(Data[] data, Dictionary parameters, CIShellContext ciShellContext) {
